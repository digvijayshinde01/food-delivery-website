...
<head>
  ...
  <link rel="icon" href="HIFI-removebg-preview.png" sizes="32x32">
...
<div>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2023<a class="grey-text text-lighten-4" href="#" target="_blank">HIFI</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">HIFI Team</a></span>
        </div>
    </div>
  </footer>
